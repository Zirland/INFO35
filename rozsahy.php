...
for ($i = 0; $i < 10; $i++) {
    ...
    if ($result26 = mysqli_query($link, $query26)) {
        ...
        if ($radky26 == 0) {
            ...
            $reg     = $i . "[0-9]+";
            $query41 = "SELECT prijmeni, nazev_ulice, cislo_popisne, cislo_orientacni, nazev_obce, nazev_casti_obce FROM stanice WHERE OpID = '111' AND tel_cislo REGEXP '$reg';";
            if ($result41 = mysqli_query($link, $query41)) {
                $radky41 = mysqli_num_rows($result41);
            }
            if ($radky41 > 0) {
                for ($j = 0; $j < 10; $j++) {
                    $query47 = "SELECT tel_cislo FROM stanice WHERE OpID = '111' AND tel_cislo LIKE '$i$j%';";
                    if ($result47 = mysqli_query($link, $query47)) {
                        ...
                        if ($radky47 == 0) {
                            ...
                            $reg     = $i . $j . "[0-9]+";
                            $query63 = "SELECT prijmeni, nazev_ulice, cislo_popisne, cislo_orientacni, nazev_obce, nazev_casti_obce FROM stanice WHERE OpID = '111' AND tel_cislo REGEXP '$reg';";
                            if ($result63 = mysqli_query($link, $query63)) {
                                $radky63 = mysqli_num_rows($result63);
                            }
                            if ($radky63 > 0) {
                                for ($k = 0; $k < 10; $k++) {
                                    $query69 = "SELECT tel_cislo FROM stanice WHERE OpID = '111' AND tel_cislo LIKE '$i$j$k%';";
                                    if ($result69 = mysqli_query($link, $query69)) {
                                        ...
                                        if ($radky69 == 0) {
                                            ...
                                            $reg     = $i . $j . $k . "[0-9]+";
                                            $query85 = "SELECT prijmeni, nazev_ulice, cislo_popisne, cislo_orientacni, nazev_obce, nazev_casti_obce FROM stanice WHERE OpID = '111' AND tel_cislo REGEXP '$reg';";
                                            if ($result85 = mysqli_query($link, $query85)) {
                                                $radky85 = mysqli_num_rows($result85);
                                            }
                                            if ($radky85 > 0) {
                                                for ($l = 0; $l < 10; $l++) {
                                                    $query91 = "SELECT tel_cislo FROM stanice WHERE OpID = '111' AND tel_cislo LIKE '$i$j$k$l%';";
                                                    if ($result91 = mysqli_query($link, $query91)) {
                                                        ...
                                                        if ($radky91 == 0) {
                                                            ...
                                                            $reg      = $i . $j . $k . $l . "[0-9]+";
                                                            $query106 = "SELECT prijmeni, nazev_ulice, cislo_popisne, cislo_orientacni, nazev_obce, nazev_casti_obce FROM stanice WHERE OpID = '111' AND tel_cislo REGEXP '$reg';";
                                                            if ($result106 = mysqli_query($link, $query106)) {
                                                                $radky106 = mysqli_num_rows($result106);
                                                            }
                                                            if ($radky106 > 0) {
                                                                for ($m = 0; $m < 10; $m++) {
                                                                    $query112 = "SELECT tel_cislo FROM stanice WHERE OpID = '111' AND tel_cislo LIKE '$i$j$k$l$m%';";
                                                                    if ($result112 = mysqli_query($link, $query112)) {
                                                                        ...
                                                                        if ($radky112 == 0) {
                                                                            ...
                                                                            $reg      = $i . $j . $k . $l . $m . "[0-9]+";
                                                                            $query127 = "SELECT prijmeni, nazev_ulice, cislo_popisne, cislo_orientacni, nazev_obce, nazev_casti_obce FROM stanice WHERE OpID = '111' AND tel_cislo REGEXP '$reg';";
                                                                            if ($result127 = mysqli_query($link, $query127)) {
                                                                                $radky127 = mysqli_num_rows($result127);
                                                                            }
                                                                            if ($radky127 > 0) {
                                                                                for ($n = 0; $n < 10; $n++) {
                                                                                    $query133 = "SELECT tel_cislo FROM stanice WHERE OpID = '111' AND tel_cislo LIKE '$i$j$k$l$m$n%';";
                                                                                    if ($result133 = mysqli_query($link, $query133)) {
                                                                                        ...
                                                                                        if ($radky133 == 0) {
                                                                                            ...
                                                                                            $reg      = $i . $j . $k . $l . $m . $n . "[0-9]+";
                                                                                            $query148 = "SELECT prijmeni, nazev_ulice, cislo_popisne, cislo_orientacni, nazev_obce, nazev_casti_obce FROM stanice WHERE OpID = '111' AND tel_cislo REGEXP '$reg';";
                                                                                            if ($result148 = mysqli_query($link, $query148)) {
                                                                                                $radky148 = mysqli_num_rows($result148);
                                                                                            }
                                                                                            if ($radky148 > 0) {
                                                                                                for ($o = 0; $o < 10; $o++) {
                                                                                                    $query154 = "SELECT tel_cislo FROM stanice WHERE OpID = '111' AND tel_cislo LIKE '$i$j$k$l$m$n$o%';";
                                                                                                    if ($result154 = mysqli_query($link, $query154)) {
                                                                                                        ...
                                                                                                        if ($radky154 == 0) {
                                                                                                            ...
                                                                                                            $query169 = "SELECT prijmeni, nazev_ulice, cislo_popisne, cislo_orientacni, nazev_obce, nazev_casti_obce FROM stanice WHERE OpID = '111' AND tel_cislo REGEXP '$reg';";
                                                                                                            if ($result169 = mysqli_query($link, $query169)) {
                                                                                                                $radky169 = mysqli_num_rows($result169);
                                                                                                            }
                                                                                                            if ($radky169 > 0) {
                                                                                                                for ($p = 0; $p < 10; $p++) {
                                                                                                                    $query175 = "SELECT tel_cislo FROM stanice WHERE OpID = '111' AND tel_cislo LIKE '$i$j$k$l$m$n$o$p%';";
                                                                                                                    if ($result175 = mysqli_query($link, $query175)) {
                                                                                                                        ...
                                                                                                                        if ($radky175 == 0) {
                                                                                                                            ...
                                                                                                                            $query190 = "SELECT prijmeni, nazev_ulice, cislo_popisne, cislo_orientacni, nazev_obce, nazev_casti_obce FROM stanice WHERE OpID = '111' AND tel_cislo REGEXP '$reg';";
                                                                                                                            if ($result190 = mysqli_query($link, $query190)) {
                                                                                                                                $radky190 = mysqli_num_rows($result190);
                                                                                                                            }
                                                                                                                            if ($radky190 > 0) {
                                                                                                                                for ($q = 0; $q < 10; $q++) {
                                                                                                                                    $query196 = "SELECT tel_cislo FROM stanice WHERE OpID = '111' AND tel_cislo LIKE '$i$j$k$l$m$n$o$p$q%';";
                                                                                                                                    if ($result196 = mysqli_query($link, $query196)) {
                                                                                                                                        ...
                                                                                                                                        if ($radky196 == 0) {
                                                                                                                                            ...
                                                                                                                                            $query203 = "SELECT prijmeni, nazev_ulice, cislo_popisne, cislo_orientacni, nazev_obce, nazev_casti_obce FROM stanice WHERE OpID = '111' AND tel_cislo = '$i$j$k$l$m$n$o$p$q';";
