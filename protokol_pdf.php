...
$pdf->Image('SPEL.png', 15, 10, 180, 43, 'PNG');
$pdf->Ln(50);
...
$pdf->Cell(0, 6, 'Ředitelství silnic a dálnic ČR', 0, 1, 'L');

$pdf->Cell(10, 6, '', 0, 0, 'L');
$pdf->Cell(25, 6, "Dodavatel:", 0, 0, 'L');
$pdf->Cell(0, 6, 'SPEL, a.s. Kolín', 0, 1, 'L');

$pdf->Cell(35, 6, '', 0, 0, 'L');
$pdf->Cell(0, 6, 'Třídvorská 1402, 280 02 Kolín V', 0, 1, 'L');
$pdf->Ln(12);

$pdf->Cell(10, 6, '', 0, 0, 'L');
$pdf->Cell(0, 6, "SPEL, a.s. provedl dne $datum_format funkční zkoušku spojení.", 0, 1, 'L');
...
$pdf->Cell($w[7], 5, 'Pozice SPEL', 1, 0, 'C');
...
Pozice SPEL – kontrola údajů evidovaných u dodavatele.
...
$pdf->Cell(0, 6, "V Kolíně dne $dnes_datum", 0, 1, 'L');
